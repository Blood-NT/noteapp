...
import { Avatar, List, Dropdown, Space, Typography } from 'antd';
...
function Home() {
    ...
    return (
        ...
        < div style={{ display: "flex", justifyContent: "space-between" }}>
            <div style={{ minWidth:"30%", maxWidth:"35%" }}>
                <Tabs
                    defaultActiveKey="1"
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between" }}>
                                <div style={{ width: "90%" }}>
                                    <List.Item.Meta style={{ whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}
                                        ...
                                        title={item.title}
                                        description={`Create: ${item.time} -- update: ${item.update}`}
            ...
            <Myform {...idnote} style={{ width: "70vw" }} />
